...
\newcommand\gj{\textsc{Gauss-Jordan}\xspace}
...
% Ce qui suit ne fonctionne plus depuis biblatex 3.3
...
\DeclareIndexNameFormat{mine}{
      \ifboolexpr{ test {\ifstrequal{Dimitri Pertin}{#1}}}
          {\addtocategory{mine}{\thefield{entrykey}}}
              {}}
